      ...
      <section className="pt-16 pb-8 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">
              What is <span className="text-primary-700">HUMUN</span>
            </h2>
          {/* What is HUMUN */}
          <div className="mb-16 text-justify">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gradient-to-r from-primary-50 to-primary-200 border-l-4 border-primary-700 p-6 rounded-r-lg mb-8">
          ...
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">
              Our <span className="text-primary-700">History</span>
            </h2>
          ...
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">
              Our <span className="text-primary-700">Legacy</span>
            </h2>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-justify">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-6">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h4 className="text-xl font-semibold text-primary-700 mb-3">Our First Delegation in 2021</h4>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h4 className="text-xl font-semibold text-primary-700 mb-3">Our Latest Achievement in 2025</h4>
                  <p className="text-gray-700">
          ...
          <div className="text-justify">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-lg">
                <div className="text-4xl font-bold text-primary-700 mb-2">1100+</div>
